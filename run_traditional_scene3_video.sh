...
# Pose-compensated, object-aware traditional RPC OGM evaluation + videos.
# Doppler always comes from the original RPC/bin velocity; no Kalman, range
# difference, or other velocity-unwrapping path is enabled here.
...
FPS="${FPS:-10}"
VIDEO_LAYOUT="${VIDEO_LAYOUT:-both}"
...
echo "Object-aware dual-branch traditional RPC OGM + videos"
...
echo "  layout    : $VIDEO_LAYOUT (static/dynamic branches and Free/BG/FG overlay)"
...
echo "              raw RPC/bin velocity, ego compensated, no unwrapping"
