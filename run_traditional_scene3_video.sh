...
# Pose-compensated, three-frame traditional RPC OGM evaluation + video for
# official test Scene 3. Defaults can be overridden with environment variables:
...
TEMPORAL_WINDOW="${TEMPORAL_WINDOW:-3}"
...
echo "Pose-temporal traditional RPC OGM + video"
