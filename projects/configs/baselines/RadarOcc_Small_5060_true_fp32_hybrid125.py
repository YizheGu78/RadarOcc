...
# val_ann_file = 'data/annotations/kradar_dict_test_doppler8.pkl'
...
#         # The only model-precision difference from official RadarOcc-S.
#         fp16=False,
#     ),
...
# # === ALIGNED_OFFICIAL_SPLIT_OVERRIDE ===
# # val/test在原配置中可能引用同一个test_config对象，
# # 必须分别deepcopy，否则修改test会同时覆盖val。
# import copy as _copy

# _aligned_train_cfg = _copy.deepcopy(data['train'])
# _aligned_val_cfg = _copy.deepcopy(data['val'])
# _aligned_test_cfg = _copy.deepcopy(data['test'])

# _aligned_train_cfg['ann_file'] = (
#     'data/annotations/'
#     'kradar_dict_train_official_doppler8.pkl'
# )
# _aligned_train_cfg['test_mode'] = False

# _aligned_val_cfg['ann_file'] = (
#     'data/annotations/'
#     'kradar_dict_val_official_doppler8.pkl'
# )
# _aligned_val_cfg['test_mode'] = True

# _aligned_test_cfg['ann_file'] = (
#     'data/annotations/'
#     'kradar_dict_test_official_doppler8.pkl'
# )
# _aligned_test_cfg['test_mode'] = True

# data['train'] = _aligned_train_cfg
# data['val'] = _aligned_val_cfg
# data['test'] = _aligned_test_cfg
...
train_ann_file = (
    'data/annotations/'
    'kradar_dict_train_official_hybrid125.pkl'
)

val_ann_file = (
    'data/annotations/'
    'kradar_dict_val_official_hybrid125.pkl'
)

test_ann_file = (
    'data/annotations/'
    'kradar_dict_test_official_hybrid125.pkl'
)
...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        # 8 radar features + 3 spatial coordinates
        input_channel=11,
    ...
    pts_bbox_head=dict(
        ...
        # RTX 5060 reproduction:
        # keep occupancy head in true FP32.
        fp16=False,
    ),
...
# -------------------------------------------------------------------------
# Independent train / validation / test dataset configurations
# -------------------------------------------------------------------------
...
# Old checkpoints were trained using incorrect Radar/GT temporal pairing.
# Do not resume from or load those checkpoints.
load_from = None
resume_from = None