...
echo "Training original Doppler dual-branch Random Forest"
echo "  velocity source: raw RPC/bin Doppler, ego compensated, no unwrapping"
echo "  temporal window: $TEMPORAL_WINDOW"
